...
SG_ID="sg-07bf1ea3d5397ec68" # replace with your SG ID
INSTANCES=("mongodb" "redis" "mysql" "rabbitmq" "catalogue" "user" "cart" "shipping" "payment" "dispatch" "frontend")
ZONE_ID="Z01891953PLU1K6VRGBFE" # replace with your ZONE ID
DOMAIN_NAME="liveyourlife.site" # replace with your domain
